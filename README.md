...
```
cd existing_repo
git remote add origin https://gitlab.lcsb.uni.lu/borja.gomezramos/gomezramos_et_al_2023.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.lcsb.uni.lu/borja.gomezramos/gomezramos_et_al_2023/-/settings/integrations)
